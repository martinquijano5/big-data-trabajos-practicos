...
parent_dir = os.path.join(current_dir, 'graficos', f'modelo_calidad_{datetime.datetime.now().strftime("%Y%m%d_%H%M%S")}')
os.makedirs(parent_dir, exist_ok=True)


#leer los datos
white_wine_data = pd.read_csv('sommelier secuenciales/generate_color_csv/red_wine_predictions.csv', sep=',')
red_wine_data = pd.read_csv('sommelier secuenciales/generate_color_csv/white_wine_predictions.csv', sep=',')

white_wine_data.name = 'white_wine_predictions'
red_wine_data.name = 'red_wine_predictions'
...
feature_columns_simple = ['alcohol', 'pH']
target_column = 'quality'

scatterplot_vs_quality(combined_data, feature_columns_simple[0], feature_columns_simple[1], simple_dir)
...
feature_columns_intermediate = ['alcohol', 'density', 'chlorides', 'pH', 'volatile acidity']
target_column = 'quality'
...
red_wine_dir = os.path.join(parent_dir, 'modelo_rojo')
...
#modelo simple 2 variables
feature_columns_simple = ['volatile acidity', 'total sulfur dioxide']
target_column = 'quality'

scatterplot_vs_quality(red_wine_data, feature_columns_simple[0], feature_columns_simple[1], simple_dir)

print("\n--- Simple model: Combined Neural Network and Logistic Regression Sensibility Analysis (1 Hidden Layer) ---")
neural_network_neurons_sensibility_analysis(red_wine_data, feature_columns_simple, target_column, simple_nn_base_regression_dir)

print("\n--- Simple model: Neural Network Sensibility Analysis (2 Hidden Layers) ---")
neural_network_two_hidden_layers_sensibility_analysis(red_wine_data, feature_columns_simple, target_column, simple_nn_dir_2_layers)

#modelo intermedio 5 variables
feature_columns_intermediate = ['volatile acidity', 'total sulfur dioxide', 'alcohol', 'sulphates', 'citric acid']
target_column = 'quality'

plot_pca(red_wine_data, feature_columns_intermediate, target_column, intermediate_dir)

print("\n--- Intermediate model: Combined Neural Network and Logistic Regression Sensibility Analysis (1 Hidden Layer) ---")
neural_network_neurons_sensibility_analysis(red_wine_data, feature_columns_intermediate, target_column, intermediate_nn_base_regression_dir)

print("\n--- Intermediate model: Neural Network Sensibility Analysis (2 Hidden Layers) ---")
neural_network_two_hidden_layers_sensibility_analysis(red_wine_data, feature_columns_intermediate, target_column, intermediate_nn_dir_2_layers)

#modelo completo todas variables
feature_columns_complete = ['fixed acidity', 'volatile acidity', 'citric acid', 'residual sugar', 'chlorides', 'free sulfur dioxide', 'total sulfur dioxide', 'density', 'pH', 'sulphates', 'alcohol']
target_column = 'quality'

plot_pca(red_wine_data, feature_columns_complete, target_column, complete_dir)

print("\n--- Complete model: Combined Neural Network and Logistic Regression Sensibility Analysis (1 Hidden Layer) ---")
neural_network_neurons_sensibility_analysis(red_wine_data, feature_columns_complete, target_column, complete_nn_base_regression_dir)

print("\n--- Complete model: Neural Network Sensibility Analysis (2 Hidden Layers) ---")
neural_network_two_hidden_layers_sensibility_analysis(red_wine_data, feature_columns_complete, target_column, complete_nn_dir_2_layers)
...
white_wine_dir = os.path.join(parent_dir, 'modelo_blanco')
...
#modelo simple 2 variables
feature_columns_simple = ['alcohol', 'volatile acidity']
target_column = 'quality'

scatterplot_vs_quality(white_wine_data, feature_columns_simple[0], feature_columns_simple[1], simple_dir)

print("\n--- Simple model: Combined Neural Network and Logistic Regression Sensibility Analysis (1 Hidden Layer) ---")
neural_network_neurons_sensibility_analysis(white_wine_data, feature_columns_simple, target_column, simple_nn_base_regression_dir)

print("\n--- Simple model: Neural Network Sensibility Analysis (2 Hidden Layers) ---")
neural_network_two_hidden_layers_sensibility_analysis(white_wine_data, feature_columns_simple, target_column, simple_nn_dir_2_layers)

#modelo intermedio 5 variables
feature_columns_intermediate = ['alcohol', 'density', 'chlorides', 'volatile acidity', 'residual sugar']
target_column = 'quality'

plot_pca(white_wine_data, feature_columns_intermediate, target_column, intermediate_dir)

print("\n--- Intermediate model: Combined Neural Network and Logistic Regression Sensibility Analysis (1 Hidden Layer) ---")
neural_network_neurons_sensibility_analysis(white_wine_data, feature_columns_intermediate, target_column, intermediate_nn_base_regression_dir)

print("\n--- Intermediate model: Neural Network Sensibility Analysis (2 Hidden Layers) ---")
neural_network_two_hidden_layers_sensibility_analysis(white_wine_data, feature_columns_intermediate, target_column, intermediate_nn_dir_2_layers)

#modelo completo todas variables
feature_columns_complete = ['fixed acidity', 'volatile acidity', 'citric acid', 'residual sugar', 'chlorides', 'free sulfur dioxide', 'total sulfur dioxide', 'density', 'pH', 'sulphates', 'alcohol']
target_column = 'quality'

plot_pca(white_wine_data, feature_columns_complete, target_column, complete_dir)

print("\n--- Complete model: Combined Neural Network and Logistic Regression Sensibility Analysis (1 Hidden Layer) ---")
neural_network_neurons_sensibility_analysis(white_wine_data, feature_columns_complete, target_column, complete_nn_base_regression_dir)

print("\n--- Complete model: Neural Network Sensibility Analysis (2 Hidden Layers) ---")
neural_network_two_hidden_layers_sensibility_analysis(white_wine_data, feature_columns_complete, target_column, complete_nn_dir_2_layers)
