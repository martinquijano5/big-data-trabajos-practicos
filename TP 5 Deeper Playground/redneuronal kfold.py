...
# Dataset 1
plt.subplot(1, 2, 1)
cm1 = confusion_matrix(y_true_all_1, y_pred_all_1)
sns.heatmap(cm1, annot=True, fmt='d', cmap='Blues')
plt.title('Matriz de Confusión - Dataset 1 (K-Fold)')
plt.xlabel('Predicción')
plt.ylabel('Valor Real')

# Dataset 8
plt.subplot(1, 2, 2)
cm8 = confusion_matrix(y_true_all_8, y_pred_all_8)
sns.heatmap(cm8, annot=True, fmt='d', cmap='Blues')
plt.title('Matriz de Confusión - Dataset 8 (K-Fold)')
plt.xlabel('Predicción')
plt.ylabel('Valor Real')
